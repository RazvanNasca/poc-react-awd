                    ...
                    <Card 
                        ...
                        description={
                            <div class="container">
                                ...
                                <ul class="row">
                                    <div class="col-1"><i class="fa-solid fa-user-tie"></i></div>
                                    <div class="col">
                                        <div class="row licence">Lect. Dr. Bufnea Darius-Vasile</div>
                                        <div class="row faculty">The course theacher</div>
                                    </div>
                                </ul>
                                <ul class="row">
                        ...
                        description={
                            <div class="container">
                                <ul class="row">
                                    <div class="col-1"><i class="fa-solid fa-list"></i></div>
                                    <div class="col">
                                        <div class="row licence">Bachelor, 2rd Year, Semester: 1st, Software Engineering</div>
                                        <div class="row faculty">Specialisation</div>
                                    </div>
                                </ul>
                                <ul class="row">
