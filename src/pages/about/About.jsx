                    ...
                    <div class="col">
                        <Card 
                            ...
                            description={
                                <div class="container">
                                    <ul class="row">
                                        <div class="col-1 icons"><i class="fa-solid fa-spinner"></i></div>
                                        <div class="col">
                                    ...
                                    <ul class="row">
                                        <div class="col-1 icons"><i class="fa-solid fa-graduation-cap"></i></div>
                                        <div class="col">
                        ...
                        <Card 
                            ...
                            description={
                                <div class="container">
                                    ...
                                    <ul class="row">
                                        <div class="col-1 icons"><i class="fa-solid fa-chalkboard-user"></i></div>
                                        <div class="col">
